...
This code forces pandas to parse the data as numerice, avoided problems with mixed types of data in columns (something is weird about ANES original .csv file - this is the kind of thing that happens with data analysis).
